...
import { useUser } from '../Main/UserContext.js';
import StoreFooter from './StoreFooter.js';
import NewsletterSubscription from '../Main/NewsletterSubscription.js';
        ...
        <Carousel>
            <Carousel.Item>
              <img
                ...
                src="https://drive.google.com/uc?export=view&id=1n00H7_yaXq0_K1HVxSoN_sH3f1nUQ_AL"
                alt="First slide"
              />
            </Carousel.Item>
            <Carousel.Item>
              <img
                className="d-block w-100"
                src="https://drive.google.com/uc?export=view&id=1D5LtAFp-jucs67F7dvIAhOyFviJEFvy1"
                alt="Second slide"
              />
            </Carousel.Item>
            <Carousel.Item>
              <img
                className="d-block w-100"
                src="https://drive.google.com/uc?export=view&id=1FDEwgF1Sga_jYGxH0stH_g7VW25yBdEJ"
                alt="Third slide"
              />
            </Carousel.Item>
          </Carousel>
